      ...
      body: IntroductionScreen(
        ...
        pages: [
          ...
          PageViewModel(
            ...
            body:
                "Hi there dear parent. We are here to help you actively participate in your children's school work.",
            image: Image.asset(
          ...
          PageViewModel(
            ...
            body:
                "We have resources to help you assist your child with the assignments with the use of AI",
            image: Image.asset(
        ...
        // ),
            ...
            ? const SizedBox.shrink() //Hide the done button when it's pressed
            : const Text(
                'Done',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
