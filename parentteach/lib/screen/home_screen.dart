...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Articles> articles = [
    Articles(
        articleTitle: 'ParentTeach Seminar',
        articleImageUrl: 'assets/images/small logo (1).png',
        articleDescription: 'Preview of what happened at our annual seminar'),
    Articles(
        articleTitle: 'How AI is changing Education',
        articleImageUrl: 'assets/images/aischool.jpeg',
        articleDescription:
            'New age in technology is here. See how it is being used in schools'),
    Articles(
        articleTitle:
            "Importance of Both Parents' Involvement In Their children's education",
        articleImageUrl: 'assets/images/onboarding1.png',
        articleDescription:
            'See why we encourage both parents to get involved'),
    Articles(
        articleTitle: 'ParentTeach Updates',
        articleImageUrl: 'assets/images/small logo (1).png',
        articleDescription:
            "Here are our recent updates. Don't be left behind, stay in the loop. "),
  ];
  ...
  bool showAllSubjects =
      false; //This will help me  choose how many cards will be seen on the listview

  bool showAllArticles =
      false; //This will help me  choose how many articles will be seen on the listview
    ...
    return Scaffold(
        ...
        body: ListView(children: [
                ...
                Expanded(
                  child: SizedBox(
                    ...
                    child: ListView.builder(
                        ...
                        itemCount: showAllSubjects
                            ? subjects.length
                            : 4 + 1, // 4 cards + 1 for More button
          ...
          ListView.builder(
              ...
              itemCount: showAllArticles
                  ? articles.length
                  : 2 + 1, // 2 articles + 1 for ReadMore button,
              itemBuilder: (context, index) {
